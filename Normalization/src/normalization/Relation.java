...
public final class Relation {
  ...
  public Set<Relation> decomposeTo2NF() {
    ...
    Set<FuncDep> violating = getFdsViolating2NF();
    ...
    result.addAll(r1.decomposeTo2NF());
    result.addAll(r2.decomposeTo2NF());
    return result;
...
//    
////    Set<FuncDep> vio_2nf = Algos.check2NF(this.attrs, this.fds);
////    for(FuncDep fd : vio_2nf)
////    {
////        mb.remove(fd);
////    }
...
//    return result;
  ...
  public Set<FuncDep> getFdsViolating2NF() {
    return Algos.check2NF(this.attrs, this.fds);
  }
  ...
  public boolean is2NF() {
    return Algos.check2NF(this.attrs, this.fds).isEmpty();
  }
