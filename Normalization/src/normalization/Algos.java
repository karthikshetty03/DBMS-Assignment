...
public class Algos {
   ...
   public static Set<FuncDep> check2NF(Set<Attribute> attrs, Set<FuncDep> fds) {
...
//      primes.addAll(k); 
    ...
    for (FuncDep fd : fds) 
    {
       ...
       // System.out.println(primes.containsAll(fd.getLeft()));
        //System.out.println(primes.contains(fd.getLeft()));
        
        //contains = 0;
      if (primes.containsAll(fd.getLeft()) && (keys.contains(fd.getLeft()) ^ primes.containsAll(fd.getLeft()))) 
      {a = 99;}
